package edu.miamioh.upadhyi.memorygame.creation
...
import edu.miamioh.upadhyi.memorygame.R
import edu.miamioh.upadhyi.memorygame.models.BoardSize
import edu.miamioh.upadhyi.memorygame.utils.BitmapScaler
...
class CreateActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val PICK_PHOTO_CODE = 61801
    }
        ...
        for ((index, photoUri) in chosenImageUris.withIndex()) {
            ...
            photoReference.putBytes(imageByteArray)
                .continueWithTask { photoUploadTask ->
                    ...
                    //progress bar showing progress of images being uploaded to firebase
